...
@Component({
  selector: 'app-angro-investment',
  templateUrl: './angro-investment.component.html',
  styleUrls: ['./angro-investment.component.css']
})
export class AngroInvestmentComponent implements OnInit{
  ...
  additionalData = {
    ...
    "investment_name": 'Angro Investment',
